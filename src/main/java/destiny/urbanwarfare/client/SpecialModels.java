package destiny.urbanwarfare.client;
...
import destiny.urbanwarfare.Reference;
...
public enum SpecialModels
{
    ...
    CROSSBOW_STRING_RELEASED("crossbow_string_released"),
    CROSSBOW_STRING_TAUT("crossbow_string_taut");
